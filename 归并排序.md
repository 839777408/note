...
![](https://unpkg.com/nan-picture/blog/20220706214942.png)

分阶段可以理解为就是递归拆分子序列的过程。

再来看看治阶段，我们需要将两个已经有序的子序列合并成一个有序序列，比如上图中的最后一次合并，要将[4,5,7,8]和[1,2,3,6]两个已经有序的子序列，合并为最终序列[1,2,3,4,5,6,7,8]，来看下实现步骤：

![](https://unpkg.com/nan-picture/blog/20220706215001.png)

![](https://unpkg.com/nan-picture/blog/20220706215004.png)
